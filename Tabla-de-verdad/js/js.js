...
function creafuncion(valor) {
    ...
    // ======================================================
    //  Mitras en valor del paréntesis   sea el del indice  del primer paréntesis  y no se ha creado el paréntesis  no se podrá escribir el mismo paréntesis de inicio 
    ...
    while (!(operando) && verdadero.includes(dato)) {
