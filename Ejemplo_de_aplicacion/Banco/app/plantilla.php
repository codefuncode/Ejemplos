      ...
      <div class="w3-panel">
        <div class="w3-row-padding" style="margin:0 -16px">
          <div class="w3-third">
            ...
            <img alt="Google Regional Map" src="/w3images/region.jpg" style="width:100%"/>
          </div>
      ...
      <div class="w3-container">
        ...
        <ul class="w3-ul w3-card-4 w3-white">
          <li class="w3-padding-16">
            <img class="w3-left w3-circle w3-margin-right" src="/w3images/avatar2.png" style="width:35px"/>
          ...
          <li class="w3-padding-16">
            <img class="w3-left w3-circle w3-margin-right" src="/w3images/avatar5.png" style="width:35px"/>
            <span class="w3-xlarge">
              Jill
            </span>
            <br/>
          ...
          <li class="w3-padding-16">
            <img class="w3-left w3-circle w3-margin-right" src="/w3images/avatar6.png" style="width:35px"/>
            <span class="w3-xlarge">
              Jane
            </span>
            <br/>
